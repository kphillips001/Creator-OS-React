...
class Settings:
    ...
    TELEGRAM_OPERATOR_ALERT_CHAT_ID = os.getenv(
        "TELEGRAM_OPERATOR_ALERT_CHAT_ID", ""
    )
    TELEGRAM_OPERATOR_ALERT_BOT_TOKEN = os.getenv(
        "TELEGRAM_OPERATOR_ALERT_BOT_TOKEN", ""
    )
    ...
    CASHAPP_TIP_URL = os.getenv("CASHAPP_TIP_URL", "")
