...
class SchemaManagerService:
    ...
    REQUIRED_TABLES: Mapping[str, Mapping[str, Any]] = {
        "ava_availability_sessions": {
            ...
            "service": "AvaHumanAvailabilityService",
            "dashboard": (),
            "columns": ("session_id", "account_scope", "state", "started_at", "transition_at",
                "daypart", "transition_provenance", "transition_reason", "ended_at", "updated_at"),
        },
        "telegram_private_inbound_messages": {
            "owner": "Telegram Private Inbound Backlog",
            "migration": "20260913_119_ava_availability_and_private_inbound_backlog.sql",
            "repository": "TelegramPrivateInboundRepository",
            "service": "TelegramPrivateInboundBacklogService",
            "dashboard": (),
            "columns": ("inbound_id", "telegram_account_scope", "telegram_user_id", "telegram_chat_id",
                ...
                "reconciliation_id", "response_operation_id", "reconciled_at", "created_at", "updated_at"),
        },
        ...
        "telegram_identity_observations": {
            "owner": "Telegram Runtime Identity",
            "migration": "20260912_116_telegram_observation_sources.sql",
            "repository": "TelegramIdentityRepository",
            "service": "TelegramIdentityService / TelegramInboundAdapter",
            "dashboard": ("Business Operations",),
            "columns": ("telegram_user_id", "telegram_chat_id", "username", "display_name", "first_observed_at", "last_observed_at", "observation_sources", "source_channel_id", "private_chat_id", "private_chat_observed_at", "participant_status"),
        },
        ...
        "telegram_relationship_controls": {
            ...
            "columns": ("relationship_control_id","creator_profile_id","fanvue_account_id","telegram_user_id",
                ...
                "communication_disposition","ignore_version","ignored_at","ignored_by",
                "unignored_at","unignored_by","resume_after_inbound_message_id",
                "created_at","updated_at"),
        },
        "telegram_relationship_ignore_events": {
            "owner": "Per-Relationship Ignore Control",
            "migration": "20260913_128_relationship_ignore_control.sql",
            "repository": "TelegramRelationshipControlRepository",
            "service": "TelegramRelationshipControlService",
            "dashboard": ("Business Relationships",),
            "columns": ("event_id","creator_profile_id","fanvue_account_id",
                "telegram_user_id","telegram_chat_id","action","ignore_version",
                "control_version","changed_by","changed_at","reason",
                "resume_after_inbound_message_id","neutralization_evidence"),
        },
        "conversation_analyses": {
            "owner": "Business Chat Conversation Analysis",
            "migration": "20260914_129_conversation_analysis.sql",
            "repository": "ConversationAnalysisRepository",
            "service": "ConversationAnalysisService",
            "dashboard": ("Business Chat",),
            "columns": ("analysis_id","creator_profile_id","fanvue_account_id",
                "relationship_key","telegram_user_id","telegram_chat_id","target_type",
                "target_message_reference","evidence_fingerprint","evidence_digest",
                "structured_result","validated_scope","failure_signatures",
                "similar_case_summary","global_repair_candidate","provider_metadata",
                "schema_version","analyzed_at"),
        },
        "conversation_repair_proposals": {
            "owner":"Conversation Repair Planning","migration":"20260914_130_conversation_repair_planning.sql",
            "repository":"ConversationRepairProposalRepository","service":"ConversationRepairPlanningService",
            "dashboard":("Business Chat",),"columns":("proposal_id","analysis_id","finding_id","creator_profile_id","fanvue_account_id","relationship_key","validated_scope","root_cause_category","failure_signature","affected_relationship_count","violated_invariant","proposed_invariant","expected_effect","preserved_behavior","known_risks","regression_requirements","repair_category","evidence_fingerprint","risk","signature","status","created_at","expires_at","approved_by","approved_at","rejected_by","rejected_at","stale_reason")},
    ...
    MIGRATION_SCHEMA_REQUIREMENTS: Mapping[str, Mapping[str, tuple[str, ...]]] = {
        ...
        "20260914_130_conversation_repair_planning.sql": {
            "conversation_repair_proposals": ("proposal_id","analysis_id","finding_id","creator_profile_id","fanvue_account_id","relationship_key","validated_scope","root_cause_category","failure_signature","affected_relationship_count","violated_invariant","proposed_invariant","expected_effect","preserved_behavior","known_risks","regression_requirements","repair_category","evidence_fingerprint","risk","signature","status","created_at","expires_at","approved_by","approved_at","rejected_by","rejected_at","stale_reason"),
            "conversation_repair_execution_authorizations": ("authorization_id","proposal_id","repair_category","validated_scope","behavioral_invariant","regression_requirements","risk","evidence_fingerprint","approved_by","approved_at","expires_at","consumed_at"),
            "conversation_repair_events": ("event_id","proposal_id","authorization_id","event_type","event_data","created_at"),
        },
        "20260914_129_conversation_analysis.sql": {
            "conversation_analyses": ("analysis_id","creator_profile_id",
                "fanvue_account_id","relationship_key","telegram_user_id",
                "telegram_chat_id","target_type","target_message_reference",
                "evidence_fingerprint","evidence_digest","structured_result",
                "validated_scope","failure_signatures","similar_case_summary",
                "global_repair_candidate","provider_metadata","schema_version",
                "analyzed_at"),
        },
        "20260913_127_market_tier_daily_resource_gate.sql": {
            "market_tier_daily_budgets": ("budget_id","creator_profile_id","fanvue_account_id","telegram_user_id","telegram_chat_id","business_date","market_tier","daily_reply_budget","business_day_start","business_day_end","created_at"),
            "market_tier_resource_policy_events": ("event_id","idempotency_key","operation_id","creator_profile_id","fanvue_account_id","telegram_user_id","telegram_chat_id","event_type","evidence","created_at"),
        },
        "20260913_126_market_tier_confirmed_reply_accounting.sql": {
            "market_tier_confirmed_reply_events": (
                "event_id", "operation_id", "creator_profile_id",
                "fanvue_account_id", "telegram_user_id", "telegram_chat_id",
                "resource_classification", "outbound_telegram_message_id",
                "confirmed_at", "recorded_at",
            ),
        },
        "20260913_125_relationship_market_tiers.sql": {
            "telegram_relationship_market_tiers": (
        ...
        "20260913_123_attention_inspection_reliability.sql": {
            "conversation_attention_inspections": (
                "request_id", "conflict_report",
            ),
        },
        "20260913_122_conversation_attention_resolution.sql": {
            "conversation_attention_inspections": (
                "inspection_id", "creator_profile_id", "fanvue_account_id",
                "relationship_key", "telegram_user_id", "attention_occurrence_id",
                "evidence_digest", "state_fingerprint", "failure_signature",
                "root_cause_scope", "validated_result", "evidence_references",
                "created_at",
            ),
            "conversation_resolution_plans": (
                "plan_id", "inspection_id", "creator_profile_id", "fanvue_account_id",
                "relationship_key", "telegram_user_id", "attention_occurrence_id",
                "state_fingerprint", "root_cause_scope", "target_operation_id",
                "causal_operation_id", "action_type", "parameters",
                "expected_mutation_entities", "provider_generation_possible",
                "customer_visible_send_possible", "signature", "approval_state",
                "execution_state", "idempotency_key", "expires_at",
            ),
            "conversation_resolution_executions": (
                "execution_id", "plan_id", "action_type", "status",
                "canonical_service", "records_changed", "result", "started_at",
            ),
            "conversation_resolution_events": (
                "event_id", "inspection_id", "plan_id", "execution_id",
                "event_type", "event_data", "created_at",
            ),
        },
        "20260913_121_conversation_attention_acknowledgements.sql": {
            "conversation_attention_acknowledgements": (
                "acknowledgement_id", "occurrence_id", "creator_profile_id",
                "fanvue_account_id", "telegram_account_scope",
                "telegram_chat_id", "telegram_user_id",
                "triggering_inbound_message_id", "causal_operation_id",
                "attention_reason", "predicate_version", "acknowledged_by",
                "acknowledged_at", "revoked_at", "revoked_by", "created_at",
            ),
        },
        "20260913_119_ava_availability_and_private_inbound_backlog.sql": {
            "ava_availability_sessions": ("session_id", "account_scope", "state", "started_at",
                "transition_at", "daypart", "transition_provenance", "transition_reason", "updated_at"),
            "telegram_private_inbound_messages": ("inbound_id", "telegram_account_scope",
        ...
        "20260912_118_customer_inbound_image_safety.sql": {
            ...
            "telegram_inbound_media_safety_results": ("safety_result_id","operation_id","attachment_id","position","safety_state","classifier","classifier_version","relevant_labels","classified_at"),
            "telegram_explicit_boundary_events": ("boundary_event_id","operation_id","creator_profile_id","fanvue_account_id","telegram_user_id","policy","delivered_at"),
        },
        "20260912_117_telegram_inbound_media.sql": {
            "telegram_inbound_media_operations": ("operation_id","creator_profile_id","fanvue_account_id","telegram_chat_id","telegram_user_id","logical_turn_key","grouped_id","caption_text","state","failure_category","retention_expires_at"),
            "telegram_inbound_media_attachments": ("attachment_id","operation_id","telegram_message_id","telegram_media_id","media_kind","position","telegram_mime_type","reported_size_bytes","actual_size_bytes","detected_format","normalized_path","content_sha256","state","failure_category"),
        },
        "20260912_116_telegram_observation_sources.sql": {
            "telegram_identity_observations": ("telegram_user_id","observation_sources","source_channel_id","private_chat_id","private_chat_observed_at","participant_status"),
            "telegram_identity_map": ("telegram_user_id","telegram_chat_id"),
        },
        "20260911_115_canonical_relationship_facts.sql": {
            "canonical_relationship_facts": ("fact_id","creator_profile_id","fanvue_account_id","subject_type","subject_id","relation","object_type","object_value","category","source_type","verification_method","confidence","usage_policy","state","superseded_by","idempotency_key"),
            "canonical_relationship_fact_audit": ("audit_id","fact_id","action","operator_source","evidence"),
        },
        "20260911_114_verified_external_customer_identities.sql": {
            ...
            "canonical_customer_materialization_audit": (
                "audit_id", "customer_commerce_profile_id", "fanvue_account_id",
                "local_fanvue_user_id", "external_fanvue_user_uuid", "action", "source",
            ),
            "verified_external_customer_identities": (
                "external_identity_link_id", "creator_profile_id", "fanvue_account_id",
                "local_fanvue_user_id", "platform", "external_numeric_id", "observation_id",
                "verification_method", "verification_source", "verified_at", "is_active",
            ),
            "verified_external_customer_identity_audit": (
                "audit_id", "external_identity_link_id", "action", "operator_source", "evidence",
            ),
        },
    ...
    TABLE_OWNERSHIP: Mapping[str, Mapping[str, Any]] = {
        ...
        "market_tier_confirmed_reply_events": {
            "owner": "Market Tier Confirmed Reply Accounting",
            "migration": "20260913_126_market_tier_confirmed_reply_accounting.sql",
            "repository": "MarketTierReplyAccountingRepository",
            "service": "MarketTierReplyAccountingService",
            "dashboard": (),
            "columns": ("event_id", "operation_id", "creator_profile_id",
                "fanvue_account_id", "telegram_user_id", "telegram_chat_id",
                "resource_classification", "outbound_telegram_message_id",
                "confirmed_at", "recorded_at"),
        },
        "telegram_relationship_market_tiers": {
            "owner": "Business Chat Manual Market Tier",
            "migration": "20260913_125_relationship_market_tiers.sql",
            "repository": "RelationshipMarketTierRepository",
            "service": "RelationshipMarketTierService",
            "dashboard": ("Business Chat",),
            "columns": ("market_tier_id","creator_profile_id","fanvue_account_id",
                "telegram_user_id","telegram_chat_id","market_tier","version",
                "changed_by","changed_at","reason","removed_by","removed_at",
                "replaced_by"),
        },
        "telegram_relationship_value_overrides": {
            "owner": "Business Chat Relationship Value Override",
            "migration": "20260913_124_relationship_value_overrides.sql",
            "repository": "RelationshipValueOverrideRepository",
            "service": "RelationshipValueOverrideService",
            "dashboard": ("Business Chat",),
            "columns": ("override_id","creator_profile_id","fanvue_account_id",
                "telegram_user_id","telegram_chat_id","classification","version",
                "changed_by","changed_at","reason","removed_by","removed_at"),
        },
        "conversation_attention_inspections": {
            "owner": "Business Chat Inspect and Resolve",
            "migration": "20260913_122_conversation_attention_resolution.sql",
            "repository": "ConversationAttentionResolutionRepository",
            "service": "ConversationAttentionResolutionService",
            "dashboard": ("Business Chat",),
            "columns": ("inspection_id","creator_profile_id","fanvue_account_id",
                "relationship_key","telegram_user_id","attention_occurrence_id",
                "evidence_digest","state_fingerprint","failure_signature",
                "root_cause_scope","validated_result","evidence_references","created_at",
                "request_id","conflict_report"),
        },
        "conversation_resolution_plans": {
            "owner": "Business Chat Inspect and Resolve",
            ...
            "service": "ConversationAttentionResolutionService",
            "dashboard": ("Business Chat",),
            "columns": ("plan_id","inspection_id","creator_profile_id","fanvue_account_id",
                "relationship_key","telegram_user_id","attention_occurrence_id",
                "state_fingerprint","root_cause_scope","action_type","signature",
                "approval_state","execution_state","idempotency_key","expires_at"),
        },
        "conversation_resolution_executions": {
            "owner": "Business Chat Inspect and Resolve",
            "migration": "20260913_122_conversation_attention_resolution.sql",
            ...
            "service": "ConversationAttentionResolutionService",
            "dashboard": ("Business Chat",),
            "columns": ("execution_id","plan_id","action_type","status",
                "canonical_service","records_changed","result","started_at","completed_at"),
        },
        "conversation_resolution_events": {
            "owner": "Business Chat Inspect and Resolve Audit",
            "migration": "20260913_122_conversation_attention_resolution.sql",
            "repository": "ConversationAttentionResolutionRepository",
            "service": "ConversationAttentionResolutionService",
            "dashboard": ("Business Chat",),
            "columns": ("event_id","inspection_id","plan_id","execution_id",
                "event_type","event_data","created_at"),
        },
        "conversation_attention_acknowledgements": {
            "owner": "Business Chat Operational Attention",
            "migration": "20260913_121_conversation_attention_acknowledgements.sql",
        ...
        "telegram_identity_observations": {
            "owner":"Telegram Runtime Identity","migration":"20260912_116_telegram_observation_sources.sql",
            "repository":"TelegramIdentityRepository","service":"TelegramIdentityService / TelegramInboundAdapter",
            "dashboard":("Business Operations",),"columns":("telegram_user_id","telegram_chat_id","username","display_name","first_observed_at","last_observed_at","observation_sources","source_channel_id","private_chat_id","private_chat_observed_at","participant_status")},
        "canonical_relationship_facts": {
            "owner":"Canonical Relationship Intelligence","migration":"20260911_115_canonical_relationship_facts.sql",
            "repository":"CanonicalRelationshipFactRepository","service":"CanonicalRelationshipFactService",
            "dashboard":("Operations",),"columns":("fact_id","creator_profile_id","fanvue_account_id","subject_type","subject_id","relation","object_type","object_value","object_data","attributes","category","source_platform","source_type","source_reference","verification_method","confidence","usage_policy","observed_at","verified_at","state","superseded_by","correction_reason","idempotency_key","created_at","updated_at")},
        "canonical_relationship_fact_audit": {
            "owner":"Canonical Relationship Intelligence Audit","migration":"20260911_115_canonical_relationship_facts.sql",
            "repository":"CanonicalRelationshipFactRepository","service":"CanonicalRelationshipFactService",
            "dashboard":("Operations",),"columns":("audit_id","fact_id","action","operator_source","evidence","occurred_at")},
        "external_customer_identity_observations": {
            "owner": "Cross-Platform Customer Identity",
            "migration": "20260911_114_verified_external_customer_identities.sql",
            "repository": "CanonicalCustomerIdentityRepository",
            "service": "CanonicalCustomerIdentityService",
            "dashboard": ("Operations",),
            "columns": ("observation_id","creator_profile_id","platform","external_numeric_id",
                "observed_username","observed_display_name","observation_source",
                "first_observed_at","last_observed_at"),
        },
        "canonical_customer_materialization_audit": {
            "owner": "Canonical Fanvue Customer Materialization",
            "migration": "20260911_114_verified_external_customer_identities.sql",
            "repository": "CanonicalCustomerIdentityRepository",
            "service": "CanonicalCustomerIdentityService",
            "dashboard": ("Operations",),
            "columns": ("audit_id","customer_commerce_profile_id","fanvue_account_id",
                "local_fanvue_user_id","external_fanvue_user_uuid","action","source","occurred_at"),
        },
        "verified_external_customer_identities": {
            "owner": "Cross-Platform Customer Identity",
            "migration": "20260911_114_verified_external_customer_identities.sql",
            ...
            "service": "CanonicalCustomerIdentityService",
            "dashboard": ("Operations",),
            "columns": ("external_identity_link_id","creator_profile_id","fanvue_account_id",
                "local_fanvue_user_id","platform","external_numeric_id","observation_id",
                "observed_username","observed_display_name","verification_method",
                "verification_source","verification_evidence","verified_at","is_active",
                "deactivated_at","deactivation_reason","created_at","updated_at"),
        },
        "verified_external_customer_identity_audit": {
            "owner": "Cross-Platform Customer Identity Audit",
            "migration": "20260911_114_verified_external_customer_identities.sql",
            "repository": "CanonicalCustomerIdentityRepository",
            "service": "CanonicalCustomerIdentityService",
            "dashboard": ("Operations",),
            "columns": ("audit_id","external_identity_link_id","action","operator_source",
        ...
        **REQUIRED_TABLES,
        ...
        "telegram_inbound_media_operations": {
            ...
            "migration": "20260912_117_telegram_inbound_media.sql",
            "repository": "TelegramInboundMediaRepository",
            "service": "TelegramInboundMediaService",
            "dashboard": (),
            "columns": ("operation_id","creator_profile_id","fanvue_account_id",
                        "telegram_chat_id","telegram_user_id","logical_turn_key",
        ...
        "telegram_inbound_media_attachments": {
            ...
            "service": "TelegramInboundMediaService",
            "dashboard": (),
            "columns": ("attachment_id","operation_id","telegram_message_id",
                        "telegram_media_id","media_kind","grouped_id","position",
                        "telegram_mime_type","original_filename","reported_size_bytes",
                        "reported_width","reported_height","actual_size_bytes",
                        "detected_format","detected_mime_type","decoded_width",
                        "decoded_height","normalized_path","content_sha256","state",
                        "failure_category","downloaded_at","validated_at","ready_at",
                        "created_at","updated_at"),
        },
        "telegram_inbound_media_safety_results": {
            "owner": "Telegram Customer Image Safety",
            "migration": "20260912_118_customer_inbound_image_safety.sql",
            "repository": "CustomerInboundImageSafetyRepository",
            "service": "CustomerInboundImageSafetyService",
            "dashboard": (),
            "columns": ("safety_result_id","operation_id","attachment_id","position",
                        "safety_state","classifier","classifier_version","relevant_labels",
                        "classified_at","created_at"),
        },
        "telegram_explicit_boundary_events": {
            "owner": "Telegram Explicit Boundary Delivery Evidence",
            "migration": "20260912_118_customer_inbound_image_safety.sql",
            "repository": "CustomerInboundImageSafetyRepository",
            "service": "CustomerInboundImageSafetyService",
            "dashboard": (),
            "columns": ("boundary_event_id","operation_id","creator_profile_id",
                        "fanvue_account_id","telegram_user_id","policy","delivered_at",
                        "created_at"),
        },
    ...
    REQUIRED_INDEXES: Mapping[str, tuple[str, ...]] = {
        ...
        "telegram_private_inbound_messages": (
            "uq_telegram_private_inbound_message_identity",
            "idx_telegram_private_inbound_backlog", "uq_telegram_private_inbound_reconciliation_operation",
        ),
        "telegram_inbound_media_operations": (
            "telegram_inbound_media_recovery_idx",
            "telegram_inbound_media_retention_idx",
            "telegram_inbound_media_safety_recovery_idx",
        ),
        "telegram_inbound_media_safety_results": (
            "telegram_inbound_media_safety_operation_idx",
        ),
        "telegram_explicit_boundary_events": (
            "telegram_explicit_boundary_lookup_idx",
        ),
        "ai_training_implementation_attempts": (
