import type { OperationsFailures, OperationsModuleSwitches, OperationsOverview, OperationsPublishing, OperationsQueues, OperationsRuntime, OperationsSchemaCertification, OperationsWorkers, PurchaseRecoveryDetail, PurchaseRecoveryQueue, TelegramIdentityReadiness } from "./types";
...
export const operationsApi = {
  ...
  schema_certification: (signal?: AbortSignal) => read<OperationsSchemaCertification>("schema-certification", signal),
